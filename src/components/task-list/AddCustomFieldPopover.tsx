...
interface AddCustomFieldPopoverProps {
  onAdd: (input: { name: string; type: CustomFieldType; options: CustomFieldOption[] }) => Promise<boolean>;
}

type IconComponent = typeof TextIcon;

const TYPE_OPTIONS: { value: CustomFieldType; label: string; icon: IconComponent }[] = [
...
export function AddCustomFieldPopover({ onAdd }: AddCustomFieldPopoverProps) {
