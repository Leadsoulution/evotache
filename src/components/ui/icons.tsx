...
export function TrashIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M6 7h12M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2m-7 0v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V7H8Z" />
    </svg>
  );
}
...
export function UserPlusIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M3 20c0-3.31 2.69-6 6-6s6 2.69 6 6M17 8h5m-2.5-2.5v5" />
    </svg>
  );
}
...
export function UsersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M16 8.5a2.75 2.75 0 1 0 0-5.5M15 14.25c2.9.4 5 2.75 5 5.75" />
    </svg>
  );
}
...
export function InboxIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M3 8 5 4h14l2 4M3 8v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8M3 8h5l1 3h6l1-3h5" />
    </svg>
  );
}
...
export function PaperclipIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M8 12.5V17a4 4 0 0 0 8 0V8a2.5 2.5 0 0 0-5 0v8a1 1 0 0 0 2 0v-6" />
    </svg>
  );
}
...
export function LinkIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M11 6.5 12.7 4.8a3.5 3.5 0 0 1 5 5L16 11.5M13 17.5l-1.7 1.7a3.5 3.5 0 0 1-5-5L8 12.5" />
    </svg>
  );
}
...
export function SparklesIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M11 3v3M11 15v3M4 9h3M15 9h3M6 6l1.5 1.5M14.5 6 13 7.5" />
      <path d="M11 6 9.5 9.5 6 11l3.5 1.5L11 16l1.5-3.5L16 11l-3.5-1.5L11 6Z" />
    </svg>
  );
}
...
export function PhoneMissedIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="m23 1-6 6" />
      <path d="m17 1 6 6" />
...
export function FingerprintIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M12 10a2 2 0 0 0-2 2c0 1.82-.45 3.53-1.24 5.03" />
      <path d="M6.6 8.3a6 6 0 0 1 10.4 4.1c0 1.14-.05 2.27-.14 3.4" />
      <path d="M17 4.6A9 9 0 0 1 21 12c0 1 0 2.3-.2 3.5" />
      <path d="M3.1 12.6A9 9 0 0 1 4.9 6" />
      <path d="M8 20.1c.6-1 1.3-2.6 1.5-3.4" />
      <path d="M12 6a6 6 0 0 1 6 6c0 1.14-.05 2.27-.14 3.4" />
      <path d="M2 12a10 10 0 0 1 18-6" />
      <path d="M14.5 20a15 15 0 0 0 1.4-3" />
    </svg>
  );
}
