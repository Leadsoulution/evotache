...
const LPR_ROWS: SeedRow[] = [
  ...
  { id: "lpr-dev", parentId: null, title: "Développement", status: "todo", priority: "high", assigneeIds: ["u7"], dueDate: daysFromToday(15), projectId: PROJECT_LPR },
  ...
  // Phase 4 — Contenu & SEO
  { id: "lpr-content", parentId: null, title: "Contenu & SEO", status: "todo", priority: "normal", assigneeIds: ["u5"], dueDate: daysFromToday(18), projectId: PROJECT_LPR },
  ...
  { id: "lpr-qa", parentId: null, title: "Tests & recette", status: "todo", priority: "normal", assigneeIds: ["u4"], dueDate: daysFromToday(21), projectId: PROJECT_LPR },
  ...
  { id: "lpr-launch", parentId: null, title: "Mise en ligne", status: "todo", priority: "high", assigneeIds: ["u2"], dueDate: daysFromToday(25), projectId: PROJECT_LPR },
  ...
  { id: "seed-19", parentId: null, title: "Set up CI/CD pipeline", status: "in_progress", priority: "high", assigneeIds: ["u7"], dueDate: daysFromToday(3), projectId: PROJECT_INTERNAL_TOOLS },
  { id: "seed-20", parentId: null, title: "Configure error monitoring (Sentry)", status: "todo", priority: "normal", assigneeIds: ["u7"], dueDate: daysFromToday(6), projectId: PROJECT_INTERNAL_TOOLS },
  { id: "seed-21", parentId: null, title: "Write internal API documentation", status: "todo", priority: "low", assigneeIds: ["u4"], dueDate: daysFromToday(9), projectId: PROJECT_INTERNAL_TOOLS },
  { id: "seed-22", parentId: null, title: "Design social media creatives", status: "in_progress", priority: "normal", assigneeIds: ["u3"], dueDate: daysFromToday(4), projectId: PROJECT_MARKETING_Q3 },
  { id: "seed-23", parentId: null, title: "Write email campaign copy", status: "todo", priority: "normal", assigneeIds: ["u5"], dueDate: daysFromToday(6), projectId: PROJECT_MARKETING_Q3 },
  { id: "seed-24", parentId: null, title: "Set up campaign analytics dashboard", status: "todo", priority: "low", assigneeIds: ["u7"], dueDate: daysFromToday(8), projectId: PROJECT_MARKETING_Q3 },
];

const ROWS: SeedRow[] = [
  { id: "seed-1", parentId: null, title: "Design the new onboarding flow", status: "in_progress", priority: "high", assigneeIds: ["u3"], dueDate: daysFromToday(2) },
  ...
  { id: "seed-3", parentId: null, title: "Write Q3 product roadmap doc", status: "todo", priority: "normal", assigneeIds: ["u6"], dueDate: daysFromToday(7) },
  { id: "seed-4", parentId: null, title: "Review pull request #482", status: "in_review", priority: "high", assigneeIds: ["u4", "u1"], dueDate: daysFromToday(0) },
  {
    id: "seed-5",
    parentId: null,
  ...
  { id: "seed-7", parentId: null, title: "Update Tailwind design tokens", status: "done", priority: "normal", assigneeIds: ["u3"], dueDate: daysFromToday(-5) },
  {
    id: "seed-8",
    parentId: null,
  ...
  { id: "seed-9", parentId: null, title: "Audit accessibility on marketing site", status: "in_review", priority: "normal", assigneeIds: ["u4"], dueDate: daysFromToday(4) },
  { id: "seed-10", parentId: null, title: "Refactor task list virtualization", status: "todo", priority: "none", assigneeIds: [], dueDate: null },
  { id: "seed-11", parentId: null, title: "Investigate flaky checkout E2E test", status: "in_progress", priority: "urgent", assigneeIds: ["u2", "u7"], dueDate: daysFromToday(0) },
  { id: "seed-12", parentId: null, title: "Draft customer changelog for release 4.2", status: "done", priority: "low", assigneeIds: ["u5"], dueDate: daysFromToday(-3) },
  { id: "seed-13", parentId: null, title: "Benchmark Postgres read replicas", status: "todo", priority: "normal", assigneeIds: ["u7"], dueDate: daysFromToday(10) },
  { id: "seed-14", parentId: null, title: "Redesign empty states across app", status: "todo", priority: "low", assigneeIds: ["u3"], dueDate: daysFromToday(14) },
  { id: "seed-15", parentId: null, title: "Ship dark mode to production", status: "in_review", priority: "high", assigneeIds: ["u2"], dueDate: daysFromToday(1) },
  {
    id: "seed-16",
    parentId: null,
  ...
  { id: "seed-17", parentId: null, title: "Clean up unused Storybook stories", status: "done", priority: "none", assigneeIds: ["u4"], dueDate: daysFromToday(-8) },
  { id: "seed-18", parentId: null, title: "Load-test websocket notifications", status: "in_progress", priority: "high", assigneeIds: ["u7"], dueDate: daysFromToday(2) },
  {
    id: "seed-25",
    parentId: null,
...
const DISPUTE_ROWS: SeedRow[] = [
  { id: "dispute-1", parentId: null, title: "Litige facturation — client Atlas Distribution", status: "in_progress", priority: "urgent", assigneeIds: ["u2", "u1"], dueDate: daysFromToday(3) },
  { id: "dispute-2", parentId: null, title: "Réclamation qualité — livraison HAWK 200R", status: "todo", priority: "high", assigneeIds: ["u4"], dueDate: daysFromToday(5) },
  { id: "dispute-3", parentId: null, title: "Retard de paiement — fournisseur pièces moteur", status: "in_review", priority: "normal", assigneeIds: ["u6"], dueDate: daysFromToday(10) },
  { id: "dispute-4", parentId: null, title: "Litige contractuel — prestataire logistique", status: "done", priority: "low", assigneeIds: ["u2"], dueDate: daysFromToday(-4) },
  {
    id: "dispute-5",
    parentId: null,
